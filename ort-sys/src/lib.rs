...
pub struct OrtApiBase {
	...
	pub GetVersionString: unsafe extern "system" fn() -> *const ::std::os::raw::c_char
}
extern "system" {
...
pub struct OrtApi {
	...
	pub CreateStatus: unsafe extern "system" fn(code: OrtErrorCode, msg: *const ::std::os::raw::c_char) -> *mut OrtStatus,
	...
	pub GetErrorMessage: unsafe extern "system" fn(status: *const OrtStatus) -> *const ::std::os::raw::c_char,
	pub CreateEnv: unsafe extern "system" fn(log_severity_level: OrtLoggingLevel, logid: *const ::std::os::raw::c_char, out: *mut *mut OrtEnv) -> OrtStatusPtr,
	...
	pub SetSessionLogId: unsafe extern "system" fn(options: *mut OrtSessionOptions, logid: *const ::std::os::raw::c_char) -> OrtStatusPtr,
	pub SetSessionLogVerbosityLevel:
		unsafe extern "system" fn(options: *mut OrtSessionOptions, session_log_verbosity_level: ::std::os::raw::c_int) -> OrtStatusPtr,
	pub SetSessionLogSeverityLevel:
		unsafe extern "system" fn(options: *mut OrtSessionOptions, session_log_severity_level: ::std::os::raw::c_int) -> OrtStatusPtr,
	...
	pub SetIntraOpNumThreads: unsafe extern "system" fn(options: *mut OrtSessionOptions, intra_op_num_threads: ::std::os::raw::c_int) -> OrtStatusPtr,
	pub SetInterOpNumThreads: unsafe extern "system" fn(options: *mut OrtSessionOptions, inter_op_num_threads: ::std::os::raw::c_int) -> OrtStatusPtr,
	pub CreateCustomOpDomain: unsafe extern "system" fn(domain: *const ::std::os::raw::c_char, out: *mut *mut OrtCustomOpDomain) -> OrtStatusPtr,
	...
	pub SessionGetOverridableInitializerName: unsafe extern "system" fn(
		session: *const OrtSession,
		index: usize,
		allocator: *mut OrtAllocator,
		value: *mut *mut ::std::os::raw::c_char
	...
	pub RunOptionsSetRunLogVerbosityLevel: unsafe extern "system" fn(options: *mut OrtRunOptions, log_verbosity_level: ::std::os::raw::c_int) -> OrtStatusPtr,
	pub RunOptionsSetRunLogSeverityLevel: unsafe extern "system" fn(options: *mut OrtRunOptions, log_severity_level: ::std::os::raw::c_int) -> OrtStatusPtr,
	pub RunOptionsSetRunTag: unsafe extern "system" fn(options: *mut OrtRunOptions, run_tag: *const ::std::os::raw::c_char) -> OrtStatusPtr,
	pub RunOptionsGetRunLogVerbosityLevel:
		unsafe extern "system" fn(options: *const OrtRunOptions, log_verbosity_level: *mut ::std::os::raw::c_int) -> OrtStatusPtr,
	pub RunOptionsGetRunLogSeverityLevel:
		unsafe extern "system" fn(options: *const OrtRunOptions, log_severity_level: *mut ::std::os::raw::c_int) -> OrtStatusPtr,
	pub RunOptionsGetRunTag: unsafe extern "system" fn(options: *const OrtRunOptions, run_tag: *mut *const ::std::os::raw::c_char) -> OrtStatusPtr,
	...
	pub IsTensor: unsafe extern "system" fn(value: *const OrtValue, out: *mut ::std::os::raw::c_int) -> OrtStatusPtr,
	pub GetTensorMutableData: unsafe extern "system" fn(value: *mut OrtValue, out: *mut *mut ::std::os::raw::c_void) -> OrtStatusPtr,
	pub FillStringTensor: unsafe extern "system" fn(value: *mut OrtValue, s: *const *const ::std::os::raw::c_char, s_len: usize) -> OrtStatusPtr,
	pub GetStringTensorDataLength: unsafe extern "system" fn(value: *const OrtValue, len: *mut usize) -> OrtStatusPtr,
	pub GetStringTensorContent: unsafe extern "system" fn(
	...
	pub GetSymbolicDimensions: unsafe extern "system" fn(
	...
	pub CompareMemoryInfo: unsafe extern "system" fn(info1: *const OrtMemoryInfo, info2: *const OrtMemoryInfo, out: *mut ::std::os::raw::c_int) -> OrtStatusPtr,
	pub MemoryInfoGetName: unsafe extern "system" fn(ptr: *const OrtMemoryInfo, out: *mut *const ::std::os::raw::c_char) -> OrtStatusPtr,
	pub MemoryInfoGetId: unsafe extern "system" fn(ptr: *const OrtMemoryInfo, out: *mut ::std::os::raw::c_int) -> OrtStatusPtr,
	...
	pub AllocatorAlloc: unsafe extern "system" fn(ort_allocator: *mut OrtAllocator, size: usize, out: *mut *mut ::std::os::raw::c_void) -> OrtStatusPtr,
	pub AllocatorFree: unsafe extern "system" fn(ort_allocator: *mut OrtAllocator, p: *mut ::std::os::raw::c_void) -> OrtStatusPtr,
	...
	pub KernelInfoGetAttribute_float: unsafe extern "system" fn(info: *const OrtKernelInfo, name: *const ::std::os::raw::c_char, out: *mut f32) -> OrtStatusPtr,
	pub KernelInfoGetAttribute_int64: unsafe extern "system" fn(info: *const OrtKernelInfo, name: *const ::std::os::raw::c_char, out: *mut i64) -> OrtStatusPtr,
	pub KernelInfoGetAttribute_string: unsafe extern "system" fn(
	...
	pub ModelMetadataGetProducerName: unsafe extern "system" fn(
		model_metadata: *const OrtModelMetadata,
		allocator: *mut OrtAllocator,
		value: *mut *mut ::std::os::raw::c_char
	) -> OrtStatusPtr,
	pub ModelMetadataGetGraphName: unsafe extern "system" fn(
		model_metadata: *const OrtModelMetadata,
		allocator: *mut OrtAllocator,
		value: *mut *mut ::std::os::raw::c_char
	) -> OrtStatusPtr,
	pub ModelMetadataGetDomain: unsafe extern "system" fn(
		model_metadata: *const OrtModelMetadata,
		allocator: *mut OrtAllocator,
		value: *mut *mut ::std::os::raw::c_char
	) -> OrtStatusPtr,
	pub ModelMetadataGetDescription: unsafe extern "system" fn(
		model_metadata: *const OrtModelMetadata,
		allocator: *mut OrtAllocator,
		value: *mut *mut ::std::os::raw::c_char
	) -> OrtStatusPtr,
	...
	pub ReleaseAvailableProviders: unsafe extern "system" fn(ptr: *mut *mut ::std::os::raw::c_char, providers_length: ::std::os::raw::c_int) -> OrtStatusPtr,
	pub GetStringTensorElementLength: unsafe extern "system" fn(value: *const OrtValue, index: usize, out: *mut usize) -> OrtStatusPtr,
	pub GetStringTensorElement: unsafe extern "system" fn(value: *const OrtValue, s_len: usize, index: usize, s: *mut ::std::os::raw::c_void) -> OrtStatusPtr,
	pub FillStringTensorElement: unsafe extern "system" fn(value: *mut OrtValue, s: *const ::std::os::raw::c_char, index: usize) -> OrtStatusPtr,
	...
	pub BindInput: unsafe extern "system" fn(binding_ptr: *mut OrtIoBinding, name: *const ::std::os::raw::c_char, val_ptr: *const OrtValue) -> OrtStatusPtr,
	pub BindOutput: unsafe extern "system" fn(binding_ptr: *mut OrtIoBinding, name: *const ::std::os::raw::c_char, val_ptr: *const OrtValue) -> OrtStatusPtr,
	...
	pub SetGlobalIntraOpNumThreads:
		unsafe extern "system" fn(tp_options: *mut OrtThreadingOptions, intra_op_num_threads: ::std::os::raw::c_int) -> OrtStatusPtr,
	pub SetGlobalInterOpNumThreads:
		unsafe extern "system" fn(tp_options: *mut OrtThreadingOptions, inter_op_num_threads: ::std::os::raw::c_int) -> OrtStatusPtr,
	pub SetGlobalSpinControl: unsafe extern "system" fn(tp_options: *mut OrtThreadingOptions, allow_spinning: ::std::os::raw::c_int) -> OrtStatusPtr,
	pub AddInitializer: unsafe extern "system" fn(options: *mut OrtSessionOptions, name: *const ::std::os::raw::c_char, val: *const OrtValue) -> OrtStatusPtr,
	...
	pub ModelMetadataGetGraphDescription: unsafe extern "system" fn(
		model_metadata: *const OrtModelMetadata,
		allocator: *mut OrtAllocator,
		value: *mut *mut ::std::os::raw::c_char
	) -> OrtStatusPtr,
	...
	pub SetCurrentGpuDeviceId: unsafe extern "system" fn(device_id: ::std::os::raw::c_int) -> OrtStatusPtr,
	pub GetCurrentGpuDeviceId: unsafe extern "system" fn(device_id: *mut ::std::os::raw::c_int) -> OrtStatusPtr,
	...
	pub AddRunConfigEntry: unsafe extern "system" fn(
	...
	pub IsSparseTensor: unsafe extern "system" fn(value: *const OrtValue, out: *mut ::std::os::raw::c_int) -> OrtStatusPtr,
	...
	pub GetSparseTensorValues: unsafe extern "system" fn(ort_value: *const OrtValue, out: *mut *const ::std::os::raw::c_void) -> OrtStatusPtr,
	...
	pub HasValue: unsafe extern "system" fn(value: *const OrtValue, out: *mut ::std::os::raw::c_int) -> OrtStatusPtr,
	pub KernelContext_GetGPUComputeStream: unsafe extern "system" fn(context: *const OrtKernelContext, out: *mut *mut ::std::os::raw::c_void) -> OrtStatusPtr,
	...
	pub GetCANNProviderOptionsAsString: unsafe extern "system" fn(
	...
	pub SetGlobalIntraOpThreadAffinity:
		unsafe extern "system" fn(tp_options: *mut OrtThreadingOptions, affinity_string: *const ::std::os::raw::c_char) -> OrtStatusPtr,
	...
	pub HasSessionConfigEntry: unsafe extern "system" fn(
		options: *const OrtSessionOptions,
		config_key: *const ::std::os::raw::c_char,
	...
	pub GetDnnlProviderOptionsAsString: unsafe extern "system" fn(
	...
	pub KernelInfo_GetNodeName: unsafe extern "system" fn(info: *const OrtKernelInfo, out: *mut ::std::os::raw::c_char, size: *mut usize) -> OrtStatusPtr,
	...
	pub GetBuildInfoString: unsafe extern "system" fn() -> *const ::std::os::raw::c_char,
	...
	pub GetROCMProviderOptionsAsString: unsafe extern "system" fn(
	...
	pub UpdateCUDAProviderOptionsWithValue: unsafe extern "system" fn(
		cuda_options: *mut OrtCUDAProviderOptionsV2,
		key: *const ::std::os::raw::c_char,
		value: *mut ::std::os::raw::c_void
	) -> OrtStatusPtr,
	...
	pub SetSymbolicDimensions: unsafe extern "system" fn(
		info: *mut OrtTensorTypeAndShapeInfo,
		dim_params: *mut *const ::std::os::raw::c_char,
		dim_params_length: usize
	) -> OrtStatusPtr,
	pub ReadOpAttr: unsafe extern "system" fn(
