...
const V29: u32 = cfg!(feature = "api-29") as u32;
const V30: u32 = cfg!(feature = "api-30") as u32;

#[rustfmt::skip]
pub const ORT_API_VERSION: u32 = 17 // minimum version
	+ V18 + V19 + V20 + V21 + V22 + V23 + V24 + V25 + V26 + V27 + V28 + V29 + V30; // We can do this because each API also enables the one before it.
